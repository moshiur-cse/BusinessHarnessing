...
namespace CEGIS_Project_ProgressApp.Controllers
{
    public class ProjectTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TypeName,TypeFullName")] ProjectType projectType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TypeName,TypeFullName")] ProjectType projectType)
        {
            if (ModelState.IsValid)
            {
